    ...
    navbarPage(title = div(img(src = "upwell_green_gray.png", style="margin-top:0px;padding-left:4px;padding-bottom:10px;padding-top:2px", height = 55),"Eastern Pacific Leatherback Movement", style = "margin-top:-13px"),
               ...
               tabPanel("Prediction Map",
                        ...
                        fluidRow(column(width = 2),
                          ...
                          fluidRow(column(width = 12, bsCollapse(id = 'textpanels', multiple = FALSE,
                                                                 bsCollapsePanel(title = p('> What is South Pacific TurtleWatch?', style = "padding:7px;background-size:200%;font-weight:bold;margin-top:0px;margin-bottom:0px;font-size:95%;border-radius:2px"), p('South Pacific TurtleWatch is an effort to understand the habitat utilization of adult Eastern Pacific leatherbacks to better management and conservation objectives. There are multiple models under development to examine and predict the movements of these critically endangered marine megafauna. The current model shown is based on data from satellite-tagged leatherbacks. It predicts the amount of time leatherbacks are expected to spend in a given area based on environmental factors that play a role in their movements. These enviromental components can be found in the second tab in the top navigation bar. A leatherback habitat utilization based on fisheries observations will eventually be added.')),
                                                                 bsCollapsePanel(title = p('> Leatherback Tagging', style = "padding:7px;background-size:200%;font-weight:bold;margin-top:0px;margin-bottom:0px;font-size:95%;border-radius:2px"), p('Eastern Pacific leatherbacks were satellite-tagged with between 2003 and 2014. Satellite tags provided an average of half a year of leatherback movement, with the longest track spanning nearly 1.5 years. Leatherback tracks that went into the model were based on daily location estimates from these tags. We only included periods when leatherbacks were not breeding. Because they behave much differently when breeding, our prediction estimates presented here do not fully capture slow-moving coastal leatherbacks during nesting times (approximately October - March).')),
                                                                 bsCollapsePanel(title = p('> Costa Rica Dome [Ecologically or Biologically Significant Marine Area (EBSA)]', style = "padding:7px;background-size:200%;font-weight:bold;margin-top:0px;margin-bottom:0px;font-size:95%"), p('The Costa Rica Dome is an important habitat area - a biological hotspot - for many marine species, such as fisheries-important tuna and blue whales that breed and calve in the area, because upwelling brings cold, nutrient-rich waters to the Dome. It forms a migratory corridor for leatherbacks leaving Costa Rican nesting beaches. The female leatherbacks departing these Costa Rican nesting beaches are critical to the survival of the species, and thus, this area should be avoided when leatherbacks are more likely to be using this corridor. It is important to note the Costa Rica Dome on the map (light blue area) is an average position of the Costa Rica Dome throughout a given year. It is not a stationary feature; each year it strengthens and moves offshore as it grows, beginning near the coast in February, building and moving offshore around the middle of the year, and disappearing around December before the yearly cycle begins again.')))))),
                            br(),
                            hr(),
                        fluidRow(column(width = 2),
                          column(width = 8,
                 ...
                 sidebarPanel(
                  ...
                  mainPanel(
                    fluidRow(
                      ...
                      # fluidRow(column(width = 12, bsCollapse(id = 'textpanels', multiple = FALSE,
                      #                 bsCollapsePanel(title = p('Leatherback Tagging', style = "padding:7px;background-size:200%;font-weight:bold;margin-top:0px;margin-bottom:0px;font-size:95%;border-radius:2px"), p('Eastern Pacific leatherbacks were satellite-tagged with between 2003 and 2014. Satellite tags provided an average of half a year of leatherback movement, with the longest track spanning nearly 1.5 years. Leatherback tracks that went into the model were based on daily location estimates from these tags. We only included periods when leatherbacks were not breeding. Because they behave much differently when breeding, our prediction estimates presented here do not fully capture slow-moving coastal leatherbacks during nesting times (approximately October - March).')),
                      #                 bsCollapsePanel(title = p('Costa Rica Dome', style = "padding:7px;background-size:200%;font-weight:bold;margin-top:0px;margin-bottom:0px;font-size:95%"), p('The Costa Rica Dome is an important habitat area - a biological hotspot - for many marine species, such as fisheries-important tuna and blue whales that breed and calve in the area, because upwelling brings cold, nutrient-rich waters to the Dome. It forms a migratory corridor for leatherbacks leaving Costa Rican nesting beaches. The female leatherbacks departing the nesting beaches are critical to the survival of the species, and thus, this area should be avoided when leatherbacks are more likely to be using this corridor. It is important to realize the Costa Rica Dome on the map (light blue area) is an average position of the Dome throughout a given year. It is not a stationary feature; each year it strengthens and moves offshore as it grows, beginning near the coast in February, building and moving offshore around the middle of the year, and disappearing around December before the yearly cycle begins again.'))))),
                      ),
                    ),
                    fluidRow(
                      br(),
